  ...
  useEffect(() => {
    ...
    fetch('https://service.palomabot.ai/stats')
      ...
      .then(data => {
        ...
        setData({
          bots_total: data.bots_total,
          volume_total: Math.ceil(data.volume_total)
        });
      })
    ...
    <SectionContainer>
      <section className={style.container}>
        <div className={style.textWrapper}>
          ...
          <h1 className={style.title}>Over {data.bots_total} intelligent and decentralized bots managing ${formattedVolume} Daily</h1>
