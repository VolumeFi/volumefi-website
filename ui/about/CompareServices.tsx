  ...
  <SectionContainer>
    <section className={style.container}>
      ...
      <p className={style.description}>
        Volume’s decentralized private-key management and workflow offerings are an attractive alternative to
        centralized providers, matching and exceeding on some of the most important requirements for developers and
        professional users.
      </p>
      <section className={style.scrollWrapper}>
