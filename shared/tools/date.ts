...
const getRemainDays = (currentTime, endTime) => {
...
const convertDateString2 = (dateStr) => {
...
const convertDateStringWithWeekDay = (dateStr, toLocal = false) => {
...
const convertTimeString = (dateStr, toLocal = false) => {
...
const getHourOffsetLocalTimezone = () => {
  const date = new Date();
